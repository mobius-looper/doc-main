...
installing a new Mobius version.  This is called the *User Library Folder*.


## User Library Folder

One of the first things you should do after installing Mobius for the first time
is setting the *User Library Folder*.  This folder will be used to store the files related
...
To set the user library folder, open the *File* menu and select *User Library*.
...
The concept of the *User Library* was added in Mobius build 42, so most of you have not been
...
To ease the transition to the User Library, Mobius will look in *both* locations
...
**Important:** If you have been using a user library folder for awhile, and change it
